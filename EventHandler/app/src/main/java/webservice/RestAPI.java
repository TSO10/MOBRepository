...
public class RestAPI {
    private final String urlString = "http://parsaproducts.somee.com/Handler1.ashx";
    ...
    public JSONObject GetAllEvents() throws Exception {
        JSONObject result = null;
        JSONObject o = new JSONObject();
        JSONObject p = new JSONObject();
        o.put("interface","RestAPI");
        o.put("method", "GetAllEvents");
        o.put("parameters", p);
        String s = o.toString();
        String r = load(s);
        result = new JSONObject(r);
    ...
    public JSONObject GetEventById(int eventId) throws Exception {
        JSONObject result = null;
        JSONObject o = new JSONObject();
        JSONObject p = new JSONObject();
        o.put("interface","RestAPI");
        o.put("method", "GetEventById");
        p.put("eventId",mapObject(eventId));
        o.put("parameters", p);
        String s = o.toString();
        String r = load(s);
        result = new JSONObject(r);
    ...
    public JSONObject CreateEvent(String headline,String description,String time,String imageUrl) throws Exception {
        JSONObject result = null;
        JSONObject o = new JSONObject();
        JSONObject p = new JSONObject();
        o.put("interface","RestAPI");
        o.put("method", "CreateEvent");
        p.put("headline",mapObject(headline));
        p.put("description",mapObject(description));
        p.put("time",mapObject(time));
        p.put("imageUrl",mapObject(imageUrl));
        o.put("parameters", p);
        String s = o.toString();
        String r = load(s);
        result = new JSONObject(r);
